/* ---------------------------------------------------------------------------
   SAVED DESIGN — the "editorial newswire" layout that lived at
   IndustryInsightsSection.jsx before it was replaced with the guest2-style
   magazine layout (image-led featured story + ranked headline list).

   Not imported anywhere — this file exists purely as a restore point. To
   bring this design back, copy this file's contents over
   IndustryInsightsSection.jsx (the matching `.cov-*` CSS is still intact in
...
export const IndustryInsightsSectionClassic = () => {
...
export default IndustryInsightsSectionClassic;
