...
const AUCTIONS = [
  { id: 'FA-1022951', material: 'Mixed Aluminium Extrusion Scrap', seller: 'Tata Steel', location: 'Jamshedpur, JH', state: 'Jharkhand', qty: '25 MT', price: '₹6,45,000', priceNum: 645000, type: 'aluminium', category: 'Non-Ferrous', isLive: true, img: '/images/auctions/aluminium_scrap.png' },
  { id: 'FA-1022952', material: 'CR Coil Secondary Stock', seller: 'SAIL', location: 'Bhilai, CG', state: 'Chhattisgarh', qty: '40 MT', price: '₹12,20,000', priceNum: 1220000, type: 'ferrous', category: 'Ferrous', isLive: true, img: '/images/auctions/cr_coil.png' },
  { id: 'FA-1022953', material: 'Copper Wire Scrap (Millberry)', seller: 'Hindalco', location: 'Renukoot, UP', state: 'Uttar Pradesh', qty: '10 MT', price: '₹8,90,000', priceNum: 890000, type: 'copper', category: 'Non-Ferrous', isLive: false, img: '/images/auctions/copper_wire.png' },
  { id: 'FA-1022954', material: 'Heavy Melting Steel Scrap (HMS 1)', seller: 'JSW Steel', location: 'Bellary, KA', state: 'Karnataka', qty: '100 MT', price: '₹34,00,000', priceNum: 3400000, type: 'ferrous', category: 'Ferrous', isLive: false, img: '/images/auctions/hms_scrap.png' },
  { id: 'FA-1022955', material: 'Zinc Dross (Top Dross)', seller: 'Hindustan Zinc', location: 'Udaipur, RJ', state: 'Rajasthan', qty: '15 MT', price: '₹4,50,000', priceNum: 450000, type: 'zinc', category: 'Minor Metals', isLive: true, img: '/images/auctions/zinc_dross.png' },
  { id: 'FA-1022956', material: 'Brass Borings & Turnings', seller: 'Local Vendor', location: 'Jamnagar, GJ', state: 'Gujarat', qty: '5 MT', price: '₹2,10,000', priceNum: 210000, type: 'brass', category: 'Non-Ferrous', isLive: false, img: '/images/auctions/brass_borings.png' },
  { id: 'FA-1022957', material: 'MS Plate Offcuts (Fresh)', seller: 'Tata Steel', location: 'Jamshedpur, JH', state: 'Jharkhand', qty: '11 MT', price: '₹6,20,000', priceNum: 620000, type: 'ferrous', category: 'Ferrous', isLive: true, img: '/images/auctions/hms_scrap.png' },
  { id: 'FA-1022958', material: 'Aluminium Ingots ADC-12', seller: 'Hindalco', location: 'Taloja, MH', state: 'Maharashtra', qty: '20 MT', price: '₹39,96,000', priceNum: 3996000, type: 'aluminium', category: 'Non-Ferrous', isLive: true, img: '/images/auctions/aluminium_scrap.png' },
  { id: 'FA-1022959', material: 'Stainless Steel 304 Scrap', seller: 'JSW Steel', location: 'Bellary, KA', state: 'Karnataka', qty: '18 MT', price: '₹26,10,000', priceNum: 2610000, type: 'ferrous', category: 'Stainless Steel', isLive: false, img: '/images/auctions/cr_coil.png' },
  { id: 'FA-1022960', material: 'Lead Battery Scrap (RSDL)', seller: 'Hindustan Zinc', location: 'Chanderiya, RJ', state: 'Rajasthan', qty: '30 MT', price: '₹41,00,000', priceNum: 4100000, type: 'zinc', category: 'Minor Metals', isLive: true, img: '/images/auctions/zinc_dross.png' },
  { id: 'FA-1022961', material: 'Copper Cathode Cut Rods', seller: 'Hindalco', location: 'Dahej, GJ', state: 'Gujarat', qty: '8 MT', price: '₹63,84,000', priceNum: 6384000, type: 'copper', category: 'Non-Ferrous', isLive: false, img: '/images/auctions/copper_wire.png' },
  { id: 'FA-1022962', material: 'HMS 80:20 Steel Scrap', seller: 'SAIL', location: 'Rourkela, OD', state: 'Odisha', qty: '60 MT', price: '₹20,40,000', priceNum: 2040000, type: 'ferrous', category: 'Ferrous', isLive: true, img: '/images/auctions/hms_scrap.png' },
];
